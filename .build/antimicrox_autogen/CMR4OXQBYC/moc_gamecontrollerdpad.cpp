...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GameControllerDPad_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GameControllerDPad_t qt_meta_stringdata_GameControllerDPad = {
    {
QT_MOC_LITERAL(0, 0, 18) // "GameControllerDPad"
...
QT_INIT_METAOBJECT const QMetaObject GameControllerDPad::staticMetaObject = { {
    QMetaObject::SuperData::link<VDPad::staticMetaObject>(),
    qt_meta_stringdata_GameControllerDPad.data,
    qt_meta_data_GameControllerDPad,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *GameControllerDPad::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GameControllerDPad.stringdata0))
